...
import exposesMap from './assets/virtualExposes-B_pWqYYr.js';
import { _ as __vitePreload } from './assets/preload-helper-CqoC6PUU.js';
import { q as qodly_0c2f8fd593aea2c48150__mf_v__runtimeInit__mf_v__ } from './assets/qodly_0c2f8fd593aea2c48150__mf_v__runtimeInit__mf_v__-BUwrKCOu.js';

const importMap = {
      
        "@ws-ui/craftjs-core": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-B6CWk5WI.js'),true              ?[]:void 0);
            return pkg;
        }
      ,
        "@ws-ui/craftjs-layers": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-B0gt6-9U.js'),true              ?[]:void 0);
            return pkg;
        }
      ,
        "@ws-ui/craftjs-utils": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-C0Hmi3r9.js'),true              ?[]:void 0);
            return pkg;
        }
      ,
        "@ws-ui/shared": async () => {
          let pkg = await __vitePreload(() => import('./assets/index.es-CzOrr-uC.js'),true              ?[]:void 0);
            return pkg;
        }
      ,
        "@ws-ui/webform-editor": async () => {
          let pkg = await __vitePreload(() => import('./assets/index.es-CG3XyJSq.js').then(n => n.p),true              ?[]:void 0);
            return pkg;
        }
      ,
        "react": async () => {
      ...
      ,
        "react-dom": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-DFMPRShA.js').then(n => n.i),true              ?[]:void 0);
            return pkg;
        }
      ,
        "react/jsx-runtime": async () => {
          let pkg = await __vitePreload(() => import('./assets/jsx-runtime-CF_OCQHO.js').then(n => n.j),true              ?[]:void 0);
            return pkg;
        }
