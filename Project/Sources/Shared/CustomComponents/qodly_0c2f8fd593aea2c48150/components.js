import { i as init_1, q as qodly_0c2f8fd593aea2c48150__mf_v__runtimeInit__mf_v__ } from './assets/qodly_0c2f8fd593aea2c48150__mf_v__runtimeInit__mf_v__-D-XQiJsX.js';
import exposesMap from './assets/virtualExposes-Yi8uz8rO.js';
import { _ as __vitePreload } from './assets/preload-helper-CqoC6PUU.js';

const importMap = {
      
        "@ws-ui/craftjs-core": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-BD2lrdl-.js'),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/craftjs-layers": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-CoM7_Xki.js'),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/craftjs-utils": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-CupQqM2_.js'),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/shared": async () => {
          let pkg = await __vitePreload(() => import('./assets/index.es-DLdxNIvE.js'),true              ?[]:void 0);
          return pkg
        }
      ,
        "@ws-ui/webform-editor": async () => {
          let pkg = await __vitePreload(() => import('./assets/index.es-BVk2k1jR.js').then(n => n.i),true              ?[]:void 0);
          return pkg
        }
      ,
        "react": async () => {
      ...
      ,
        "react-dom": async () => {
          let pkg = await __vitePreload(() => import('./assets/index-DRexcoiR.js').then(n => n.i),true              ?[]:void 0);
          return pkg
        }
      ,
        "react/jsx-runtime": async () => {
          let pkg = await __vitePreload(() => import('./assets/jsx-runtime-Q35ZuJB8.js').then(n => n.j),true              ?[]:void 0);
          return pkg
        }
      ...
      const usedShared = {
          ...
          "@ws-ui/craftjs-core": {
            ...
            scope: ["default"],
            loaded: false,
            from: "qodly_0c2f8fd593aea2c48150",
            async get () {
...
const initTokens = {};
  ...
  const mfName = "qodly_0c2f8fd593aea2c48150";
  async function init(shared = {}, initScope = []) {
    ...
    qodly_0c2f8fd593aea2c48150__mf_v__runtimeInit__mf_v__.initResolve(initRes);
    return initRes
  }
